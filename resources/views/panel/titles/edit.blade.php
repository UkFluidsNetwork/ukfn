...
<h2 class='line-break'>Edit: {{ $title->name }}</h2>

{!! Form::model($title, [
'method' => 'PATCH',
'action' => ['TitlesController@update', $title->id],
...
<div class='form-group {{ $errors->has('name') ? ' has-error line-break-dbl' : '' }}'>
  ...
  <div class=' col-lg-8'>
    {!! Form::text('name', $title->name, ['class' => 'form-control','placeholder' => 'The title']) !!}
    @if ($errors->has('name'))
...
<div class='form-group {{ $errors->has('shortname') ? ' has-error line-break-dbl' : '' }}'>
  ...
  <div class=' col-lg-8'>
    {!! Form::text('shortname', $title->shortname, ['class' => 'form-control','placeholder' => 'The abbreviation of the title']) !!}
