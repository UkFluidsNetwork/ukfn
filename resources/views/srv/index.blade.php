...
@section('content')
  ...
  <div class="well">
    ...
    <section class="page-header line-break-dbl">
        <h3 class="text-danger line-break">Advancing Atmospheric Models: Aspects of Spatial Discretisation</h3>
        ...
        <div class="line-break-dbl-top display-block line-breakdbl">
            <p>
    ...
    <section class="page-header line-break-dbl">
        <h3 class="text-danger line-break">Controlling nematic microfluidics: a merger of modelling, simulation and experiments</h3>
    ...
    <section class="page-header line-break-dbl">
        <h3 class="text-danger line-break">Exploration of integrated microfluidics with phononics and acoustofluidics based on thin-film platform</h3>
    ...
    <section class="page-header line-break-dbl">
        <h3 class="text-danger line-break">Interrogating local shear effects on coherent structure identification in turbulent flows</h3>
    ...
    <section class="page-header line-break-dbl">
        <h3 class="text-danger line-break">Towards a mechanistic understanding of haematocrit changes in tumour vasculature</h3>
