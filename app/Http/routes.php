...
Route::get('robots/talks', 'TalksController@allTalksList');
...
Route::get('api/ecphotos', 'UsersController@ecphotosJson');
...
Route::get('api/ecphotos', 'UsersController@ecphotosJson');
Route::get('api/ecmembers/', 'UsersController@getEcJson');
...
Route::get('panel/users/ec', 'UsersController@ecmembers')->middleware('admin');
...
Route::post('users/ec/{action}', 'UsersController@administerEcMember')->middleware('admin');
